...
while ( n < 55 and valid_results):
    ...
    print(n,r_2, r_1, result_list[len(result_list)-1])
    if(sequence_checker(result_list) == False or r_1 != result_list[len(result_list)-1] or r_2 != result_list[len(result_list)-1]):
        valid_results = False
        print("Failed!")
    n = n + 1
